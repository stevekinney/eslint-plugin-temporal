...
export const recommendedRules: TSESLint.FlatConfig.Rules = {
  ...
  'temporal/workflow-no-continue-as-new-in-update-handler': 'error',
  'temporal/workflow-no-continue-as-new-without-state-argument': 'warn',
  'temporal/workflow-no-crypto-random': 'error',
  ...
  'temporal/workflow-local-activity-options-required': 'warn',
  ...
  'temporal/workflow-no-shared-array-buffer': 'error',
  ...
  'temporal/workflow-require-set-handler-early': 'warn',
  ...
  'temporal/test-worker-run-until-required': 'warn',
