...
export const preferSingleObjectWorkflowArgs = createWorkflowRule<[], MessageIds>({
  name: 'workflow-prefer-single-object-args',
  meta: {
    type: 'suggestion',
    docs: {
      description:
    ...
    messages: {
      preferSingleObject:
        'Prefer a single object parameter for workflows. This workflow has {{ count }} parameters.',
    },
    schema: [],
  },
  defaultOptions: [],
