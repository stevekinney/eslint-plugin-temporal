...
export const strictRules: TSESLint.FlatConfig.Rules = {
  ...
  'temporal/workflow-no-workflow-prng-for-persisted-ids': 'error',
  ...
  'temporal/workflow-no-large-inline-constants': 'error',
  'temporal/workflow-local-activity-options-required': 'error',
  'temporal/workflow-no-nonserializable-types-in-payloads': 'error',
  'temporal/workflow-no-error-as-payload': 'error',
  'temporal/workflow-no-bigint-in-payload': 'error',
  'temporal/workflow-no-date-object-in-payload': 'error',
  ...
  'temporal/workflow-prefer-local-activity-for-nondeterministic-value': 'error',
