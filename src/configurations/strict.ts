...
export const strictRules: TSESLint.FlatConfig.Rules = {
  ...
  'temporal/workflow-deprecate-patch-requires-comment': 'error',
  'temporal/workflow-message-name-literal': 'error',
  ...
  'temporal/workflow-prefer-condition-over-polling': 'error',
  'temporal/workflow-prefer-sleep': 'error',
  'temporal/workflow-require-activity-timeouts': 'error',
  'temporal/workflow-require-activity-retry-policy': 'error',
  ...
  'temporal/workflow-require-all-handlers-finished': 'error',
  'temporal/workflow-require-set-handler-early': 'error',
  ...
  'temporal/workflow-update-handler-return-type': 'error',
