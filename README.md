...
| [`workflow-no-crypto-random`](documentation/rules/workflow-no-crypto-random.md)                                                                   | Disallow `crypto.randomBytes()`, `getRandomValues()`, `randomFillSync()`.      |         |    error    |
...
| [`workflow-no-shared-array-buffer`](documentation/rules/workflow-no-shared-array-buffer.md)                                                       | Disallow `SharedArrayBuffer` and `Atomics` (non-deterministic).                |         |    error    |
